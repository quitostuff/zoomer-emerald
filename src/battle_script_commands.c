...
{
    FLAG_HIDE_PETALBURG_WOODS_DEVON_EMPLOYEE , FLAG_BADGE01_GET, FLAG_BADGE02_GET, FLAG_HIDE_SLATEPORT_CITY_OCEANIC_MUSEUM_2F_ARCHIE,
    FLAG_BADGE03_GET, FLAG_DEFEATED_EVIL_TEAM_MT_CHIMNEY, FLAG_BADGE04_GET, FLAG_BADGE05_GET,
    FLAG_HIDE_ROUTE_119_TEAM_AQUA, FLAG_BADGE06_GET, FLAG_HIDE_LILYCOVE_CITY_RIVAL, FLAG_GROUDON_AWAKENED_MAGMA_HIDEOUT,
    FLAG_BADGE07_GET, FLAG_KYOGRE_ESCAPED_SEAFLOOR_CAVERN, FLAG_BADGE08_GET, FLAG_DEFEATED_WALLY_VICTORY_ROAD, 
    FLAG_ENTERED_ELITE_FOUR, FLAG_IS_CHAMPION
};

const u16 sLevelCaps[NUM_SOFT_CAPS] = { 12, 17, 21, 24, 
                                        27, 30, 33, 36, 
                                        40, 42, 44, 46, 
                                        48, 52, 55, 58, 
                                        62, 100 };
