...
const u32 gItemIcon_TradeToken[] = INCBIN_U32("graphics/items/icons/Trade_Token.4bpp.lz");
const u32 gItemIconPalette_TradeToken[] = INCBIN_U32("graphics/items/icon_palettes/Trade_Token.gbapal.lz");

const u32 gItemIcon_GameCoupon[] = INCBIN_U32("graphics/items/icons/Game_Coupon.4bpp.lz");
const u32 gItemIconPalette_GameCoupon[] = INCBIN_U32("graphics/items/icon_palettes/Game_Coupon.gbapal.lz");