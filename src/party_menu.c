...
void ItemUseCB_RareCandy(u8 taskId, TaskFunc task)
{
    ...
    // src/battle_script_commands.c line 3935 as the base idea
    for(i = 0; i < NUM_SOFT_CAPS; i++)
    {
        //if you are at or beyond a level cap, then cannotUseEffect = true
...
*/
    ...
    else
    {
        ...
        if(gSpecialVar_ItemId != ITEM_COMMON_CANDY)
            RemoveBagItem(gSpecialVar_ItemId, 1);
        GetMonNickname(mon, gStringVar1);
